    ...
    <div class="container mx-auto mt-20 p-6 bg-white shadow-md rounded-md">
        <div class="grid grid-cols-3 gap-4">
            <div class="col-span-1">
                ...
                <p class="text-center mb-6">Saldo: €<?= number_format(htmlspecialchars($user['balance'], ENT_QUOTES, 'UTF-8'), 2, ',', '.') ?></p>
                <div class="flex justify-center">
                    ...
                    <div class="bg-red-100 p-2 rounded">
                        <?php foreach ($outgoingTransactions as $transaction): ?>
                            <div class="flex justify-between mb-2">
                                ...
                                <p>€<?= number_format(htmlspecialchars($transaction['amount'], ENT_QUOTES, 'UTF-8'), 2, ',', '.') ?></p>
                            </div>
                        <?php endforeach; ?>
                    </div>
                <?php else: ?>
